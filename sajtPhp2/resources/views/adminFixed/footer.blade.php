    ...
    <div class="bg-secondary rounded-top p-4">
        <div class="row">
            <div class="col-12 col-sm-6 text-center text-sm-start">
                &copy; <a href="/">Laptop Store</a>, All Right Reserved.
            </div>
...
<script src="{{asset('assets/adminAsset/lib/waypoints/waypoints.min.js')}}"></script>
<script src="{{asset('assets/adminAsset/lib/owlcarousel/owl.carousel.min.js')}}"></script>
<script src="{{asset('assets/adminAsset/lib/tempusdominus/js/moment.min.js')}}"></script>
