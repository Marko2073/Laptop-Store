...
@section('content')
                        ...
                        <div class="row px-xl-6 d-flex align-items-center">
                            <div class="col-lg-6">
                                <div id="RandomProduct" >
                                    ...
                                    <img class="w-100 h-100" src="{{$productsRandom[0]->picture}}" alt="Image">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6">
                                <div id="RandomProduct">
                                    <a href="/">
                                        <img class="w-100 h-auto" src="{{$productsRandom[1]->picture}}" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6">
                                <div id="RandomProduct">
                                    <a href="/">
                                        <img class="w-100 h-auto" src="{{$productsRandom[2]->picture}}" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-5"><span class="bg-secondary pr-3">Our just arrived products</span></h2>
        <div class="row px-xl-5">
        ...
        <div class="row px-xl-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{$product->brand_name. ' ' . $product->name}}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
